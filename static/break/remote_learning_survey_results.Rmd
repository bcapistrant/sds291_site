---
title: "Moving Forward After Spring Break"
linktitle: "1 Remote Learning Survey"
date: "2020-03-20"
menu:
  announcements:
    weight: 1
...
library(tidyverse)
RL_deID <- read_csv("~/Dropbox/3_Smith/SDS291/sds291_site/static/break/RL_deID.csv")
```
...
```{r activityplot, out.width= "65%", out.extra='style="float:right; padding:10px"'}
activity_plot
```
