...
|-----|------------|------------|------------|------------|------------|------------|------------|
| Log(odds) | `r m1_data$logodds[1]`  |  `r m1_data$logodds[11]` | `r m1_data$logodds[12]` | `r m1_data$logodds[16]` | `r m1_data$logodds[21]` | `r m1_data$logodds[22]`  |  `r m1_data$logodds[31]` |
| Odds | `r m1_data$odds[1]`  |  `r m1_data$odds[11]` | `r m1_data$odds[12]` | `r m1_data$odds[16]` | `r m1_data$odds[21]` | `r m1_data$odds[22]`  |  `r m1_data$odds[31]` |
| Probability|  `r m1_data$prob[1]`  |  `r m1_data$prob[11]` | `r m1_data$prob[12]` | `r m1_data$prob[16]` | `r m1_data$prob[21]` | `r m1_data$prob[22]`  |  `r m1_data$prob[31]` |

```{r, fig.width=3.5, fig.height=3.5, echo=FALSE, warning= FALSE}
glimpse(m1_data)
```
