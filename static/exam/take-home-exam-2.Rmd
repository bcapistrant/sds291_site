...
c. Is this model better than the simple logistic regression models you fit in Exercise 2? Conduct a test that compares the models, and explain what you conclude in the context of this problem (i.e., what does this test tell us about these particular relationships)?

# 4. Communicating Take-Away Message
