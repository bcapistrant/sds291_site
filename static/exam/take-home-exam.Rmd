...
15. Does this CI include 0? Based on your answers in 3b3, did you expect the CI would include 0? Why or why not?

### Intercept Inference

**(Hint: the structure of the hypotheses and the tests is the same for the intercept as for the slope)**
