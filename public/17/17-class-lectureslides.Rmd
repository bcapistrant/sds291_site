...
### Slope
Higher slope terms tend to flatten out the line in the top of the curve (where the response=1), and smaller values make the curve look more like the odds function, where it curves down and mostly goes through the values of the response = 0.
