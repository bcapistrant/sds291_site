...
Submit this as a pdf to moodle. The pdf doesn't *need* to be made R - you can make it in Google Docs or Word, just saved as a pdf - especially for the draft, but here is an e 
