...
### e. Estimate the expected value of two houses, each with 2 bedrooms, one that's 0.25 and another that is 1.25 miles from the rail trail. Interpret this value in a sentence.
