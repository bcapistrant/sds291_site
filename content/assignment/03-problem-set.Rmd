...
- `Distance`: Distance (in *feet* - note the different unit from the in class exercise) to the nearest entry point to the rail trail network
...
### d. Estimate the expected value of two houses, each 2000 _feet_ from the trail, one with 3 and one with 4 bedrooms. Interpret this value in a sentence.

### e. Estimate the expected value of two houses, each with 2 bedrooms, one that's 1500 and another that is 2500 _feet_ from the rail trail. Interpret this value in a sentence.
