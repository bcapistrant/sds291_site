...
- ✔+: (*33 points (110%) in gradebook*) Problem set is 100% completed. Every question was attempted and answered, and most answers are correct. Document is clean and easy to follow. Work is exceptional. I will not assign these often.
- ✔: (*28 points (93%) in gradebook*) Problem set is 70–99% complete and most answers are correct. **This is the expected level of performance.**
- ✔−: (*15 points (50%) in gradebook*) Problem set is less than 70% complete and/or most answers are incorrect. This indicates that you need to improve next time. I will hopefully not asisgn these often.
...
Important points to consider for a complete assignment:

- answer in complete sentences
- use the conditions/terminology for scatterplots we talked about in class
- answer in the context of these data and the question (i.e., use the units, so that it's easily interpretable)
  - For example: with the Porsche data, convert the miles back to 1000s, and the price into $; see p. 29 for a good interpretation of slope and intercept in the context of the problem
- explain your rationale and evidence for why you think something is or isn't true for subjective questions (e.g., 1.9c)
- state the null and alternative hypotheses for any statistical tests
- submit both .Rmd code and knitted PDF on Moodle
- Use the server to make your life easier with knitting to PDF
- _**Knit early**_ so pesky errors don't cause trouble just before the deadline
...
These assignments will be graded using the same check system from the problem sets.
...
This assignment will be graded using the same check system from the problem sets.
