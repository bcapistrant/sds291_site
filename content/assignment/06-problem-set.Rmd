...
Estimate the relationship between Number of Hospitals and Doctors within a sample of counties `CountyHealth`.
...
c. From the table above, calculate the proportion of those who survived in the youngest group and compare this answer to your answer in "b".
