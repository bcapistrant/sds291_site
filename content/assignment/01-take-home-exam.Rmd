...
- The assignment is [here.](http://sds291.netflify.com/exam/take-home-exam.csv)
...
- The file should be knitted to a `.pdf.` and submitted with your `.rmd` file on Moodle, just like a homework/problem set.  Check your section's moodle page for more details.
- You can read in the data directly, as below:

```{r, eval=FALSE}
data<-read.csv("http://sds291.netflify.com/exam/291birthweight.csv")
```
...
I will also be having student hours on Wednesday (11-1pm). Note that these are a different time than usual student hours on Wednesday.

You can ask Stat TAs about general concepts for the exam. For example, if you're wondering about how to interpret the slope, you can work with the Stat TAs about examples from the book, from class, or previous problem sets. 
