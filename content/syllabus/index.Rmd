...
The course assignments will include a homework assignment and quizes most weeks of the course, three individual, take-home projects, and a group project with sections/drafts due throughout the course culminating in a final presentation and paper. The homework and the group project are the backbone of this course and must be completed satisfactorily to receive an A or B grade in the course.
...
### Take Home, Individual Projects

There will be three, shorter take-home projects throughout the semester. More details about the format and content of the projects will be available closer to the projects. There will not be a final exam during finals period; your project report will be due during that time.
...
- **10%** of your grade will be determined by a first individual, take home project on simple linear regression.

- **10%** of your grade will be determined by a second individual, take home project on multiple linear regression.

- **10%** of your grade will be determined by a third individual, take home project on logistic regression.
...
Again, every word that you write must be your own. Copying and pasting sentences, paragraphs, or blocks of `R` code from another student is not acceptable, will receive no credit, and warrants notification of the Academic Honor Board. Similarly, Moodle quizes and take-home projects should be completed independently and should not be discussed with other students during the open individual take home project/quiz window. Per College policy, suspected violations will be reported to Academic Honor Board.
