...
```{r echo=FALSE}
blogdown::shortcode('youtube', 'KCKDULGkPbI')
```
...
```{r echo=FALSE}
blogdown::shortcode('youtube', 'F_tGm-Aj-4M')
```
...
```{r echo=FALSE}
blogdown::shortcode('youtube', 'O_oE3xfDOyE')
```

### Part 3 - Example 1.3: Fitting a Regression Model

```{r echo=FALSE}
blogdown::shortcode('youtube', 'A24FVWmrzVI')
```

## 1.3 - Assessing Conditions

```{r echo=FALSE}
blogdown::shortcode('youtube', 'MAoN73IeNto')
```
